...
const Footer = () => {
  return (
    <footer className="bg-navy-900 text-navy-400 pt-16 pb-8">
          ...
          <div>
            <div className="flex items-center space-x-2 mb-6">
              <div className="flex items-center">
                ...
                <MessageSquare className="h-5 w-5 text-teal-400 -ml-2" />
              </div>
              <span className="text-xl font-bold text-white">SecureComm</span>
            </div>
            
            <p className="text-sm mb-6">
              A unified communication platform with end-to-end encrypted email and messaging, plus integrated payment solutions.
            </p>
